  ...
  function changeDirection() {
    ...
    switch (character) {
      case "f": {
        ...
        if (widthHalved < 0 || widthHalved > document.documentElement.clientWidth) x = getRandomInt(document.documentElement.clientWidth);
        if (heightHalved < 0 || heightHalved > document.documentElement.clientHeight) y = getRandomInt(document.documentElement.clientHeight);
        paths.push({
          x: widthHalved,
          y: heightHalved
        });
